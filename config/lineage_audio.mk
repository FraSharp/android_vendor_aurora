...
ALARM_PATH := vendor/aurora/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aurora/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aurora/prebuilt/common/media/audio/ringtones
